...
import { Crown, User, Calendar, DollarSign, Sparkles, Heart } from 'lucide-react';
    ...
    <GlassCard className="p-6 border-gold-400/30 space-y-6">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-gold-400/20">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-serif-luxury text-base font-bold text-silk-100">Recipient Profile</h3>
        </div>
